...
class QuestionMethodTests(TestCase):
	...
	def test_was_published_recently_with_future_question(self):
		"""
		test_was_published_recently() should return False for questions whose pub_date is in the future.
		"""
	...
	def test_was_published_recently_with_old_question(self):
		"""
		test_was_published_recently() should return False for questions whose pub_date is older than 1 day.
		"""
		time = timezone.now() - datetime.timedelta(days=30)
		future_question = Question(pub_date = time)
		self.assertEqual(future_question.was_published_recently(), False)
	...
	def test_was_published_recently_with_recent_question(self):
		"""
		test_was_published_recently() should return True for questions whose pub_date is within the last day.
		"""
